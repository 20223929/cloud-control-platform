...
import com.hgsoft.ecip.web.rbac.entity.SysrUser;
import com.hgsoft.ecip.web.rbac.service.SysrUserService;
...
public class SysUserAloneMerchantController {

    @Autowired
    private SysUserMerchantService sysUserMerchantService;
    @Autowired
    private SysrUserService sysrUserService;
    @Autowired
    ...
    public ResultBean userPage(@RequestBody SysrUser sysrUser, Page<SysrUser> page, String queryDeptId, Integer queryAppId) {
        ...
        Page<SysrUser> userPage = (Page<SysrUser>) sysrUserService.userPage(queryAppId, queryDeptId, sysrUser, page, ShiroSecurityUtil.userId());
