  ...
  <div class="app-container">
    ...
    >
      <template v-slot:toolbar_buttons>
        ...
        <el-button v-permission="['settlementReport:export']" type="primary" @click="exportExcel">导出</el-button>
        <el-button type="default" @click="handleReset">重置</el-button>
        <el-button @click="getData">刷新</el-button>
      </template>
      <template v-slot:operation="{ row }">
        <el-button type="primary" @click="updateById(row.sysId)" :disabled="row.bankTransferSta == 1">转账</el-button>
...
import { getData, getMerchantTreeData, update} from '@/api/modules/report/settlementReportApi'
import RejectDetail from "@/views/modules/settlementReject/view";
import { download } from 'ecip-web/utils'

export default {
  name: 'ModulesReportSettlementReportView',
  ...
  data() {
    return {
      ...
      exportUrl: 'api/v1/report/settlementReport/exportExcel',
      tableToolbar: {
        id: 'modules.report.settlementReportView-toolbar',
        custom: true,
        slots: {
      ...
      columns: [
        ...
        { title: '交易日期', field: 'trxDate', tableField: 'trx_date', minWidth: 180, sortable: true },
        ...
        { title: '服务费率', field: 'serviceRateTxt', tableField: 'service_rate', minWidth: 180, sortable: false, align: 'center' },
        ...
        { title: '状态', field: 'bankTransferStaTxt', tableField: 'bank_transfer_sta', minWidth: 180, sortable: false, align: 'center' },
  ...
  methods: {
    ...
    updateById(rowId) {
      ...
      this.$confirm(`是否确认对所选记录进行转账处理`, '提示', {
    ...
    footerMethod({ columns, data }) {
      ...
      const footData = [
        columns.map((column, columnIndex) => {
          ...
          } else if (['serviceRateTxt', 'serviceSettlementIntervalTxt'].includes(column.property)) {
            return '-'
