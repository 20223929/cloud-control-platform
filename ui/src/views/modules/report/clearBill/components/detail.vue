      ...
      <el-form ref="form" v-loading="loading" class="form-full" :model="formItem" label-width="120px" label-suffix=" : ">
        <el-row :gutter="15">
          <el-col :span="12">
            ...
            >
              <ec-date v-model="formItem.trxDate" type="datetime" format="yyyy-MM-dd" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item
...
import { findByPrimaryKey, save, update } from '@/api/modules/report/clearBillApi'

export default {
  name: 'ModulesReportClearBillForm',
  components: {},
  data() {
    return {
      visible: false,
