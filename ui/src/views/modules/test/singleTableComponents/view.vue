  ...
  <div class="app-container">
    ...
    >
      <template v-slot:toolbar_buttons>
        <el-button v-permission="['singleTableComponents:add']" type="primary" @click="add()">新增</el-button>
        <el-button v-permission="['singleTableComponents:edit']" type="warning" :disabled="!onlyOne" @click="edit()">编辑</el-button>
        <el-button v-permission="['singleTableComponents:delete']" type="danger" :disabled="!oneMore" @click="deleteByIds()">删除</el-button>
        <el-button v-permission="['singleTableComponents:import']" type="success" @click="importVisible = true">导入</el-button>
        <el-button v-permission="['singleTableComponents:export']" type="primary" @click="exportExcel">导出</el-button>
      ...
      <template v-slot:operation="{ row }">
        <el-button v-permission="['singleTableComponents:edit']" type="warning" @click="edit(row)">编辑</el-button>
        <el-button v-permission="['singleTableComponents:delete']" type="danger" @click="deleteByIds(row.id)">删除</el-button>
      </template>
    </vxe-grid>
    ...
    <detail ref="singleTableComponentsDialog" @refreshData="getData" />
...
import { getData, deleteByIds } from '@/api/modules/test/singletablecomponents/singleTableComponentsApi'
import Detail from './components/detail'
import { download } from 'ecip-web/utils'

export default {
  name: 'ModulesTestSingletablecomponentsSingleTableComponentsView',
  components: { Detail },
  ...
  data() {
    return {
      ...
      importUrl: 'api/v1/test/singletablecomponents/singleTableComponents/importExcel',
      tplUrl: 'api/v1/test/singletablecomponents/singleTableComponents/excelTemplate',
      exportUrl: 'api/v1/test/singletablecomponents/singleTableComponents/exportExcel',
      tableToolbar: {
        id: 'modules.test.singletablecomponents.singleTableComponentsView-toolbar',
        custom: true,
        slots: {
  ...
  methods: {
    ...
    add() {
      this.$refs.singleTableComponentsDialog.init('add')
    },
    edit(row) {
      const record = row || this.selections[0]
      this.$refs.singleTableComponentsDialog.init('edit', record)
    },
    deleteByIds(rowId) {
